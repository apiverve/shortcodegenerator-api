...
class shortcodegeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/shortcodegenerator');
        }
        ...
        this.validationRules = {"count":{"type":"integer","required":false,"min":1,"max":100,"default":1},"length":{"type":"integer","required":false,"min":4,"max":32,"default":8},"charset":{"type":"string","required":false,"default":"alphanumeric"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/shortcodegenerator`);
        }
    }
...
module.exports = shortcodegeneratorWrapper;
