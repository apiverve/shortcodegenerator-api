# Short Code Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:shortcodegenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.shortcodegenerator.ShortCodeGeneratorAPIClient;
import com.apiverve.shortcodegenerator.APIResponse;
import com.apiverve.shortcodegenerator.APIException;

// Initialize the client
ShortCodeGeneratorAPIClient client = new ShortCodeGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("count", 1);
    parameters.put("length", 8);
    parameters.put("charset", "alphanumeric");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/shortcodegenerator](https://docs.apiverve.com/ref/shortcodegenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/shortcodegenerator](https://docs.apiverve.com/ref/shortcodegenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/shortcodegenerator-api/issues)
