...
// Request contains the parameters for the Short Code Generator API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"length": {Type: "integer", Required: false, Min: float64Ptr(4), Max: float64Ptr(32)},
...
// ResponseData contains the data returned by the Short Code Generator API.
