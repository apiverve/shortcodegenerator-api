// Package shortcodegenerator provides a Go client for the Short Code Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/shortcodegenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/shortcodegenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Short Code Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Short Code Generator API client.
...
// Execute makes a request to the Short Code Generator API with typed parameters.
//
...
//   - count: integer - Number of codes to generate [min: 1, max: 100]
//   - length: integer - Length of each code [min: 4, max: 32]
