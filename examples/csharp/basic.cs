...
{
    class ShortCodeGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/shortcodegenerator";

        /// <summary>
        /// Make a GET request to the Short Code Generator API
        /// </summary>
        static async Task<JsonDocument> CallShortCodeGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; &quot;5&quot;, [&quot;length&quot;] &#x3D; &quot;8&quot;, [&quot;charset&quot;] &#x3D; &quot;alphanumeric&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Short Code Generator API...\n");

            var result = await CallShortCodeGeneratorAPI();
