...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/shortcodegenerator',
        'Source': 'https://github.com/apiverve/shortcodegenerator-api',
        'Bug Tracker': 'https://github.com/apiverve/shortcodegenerator-api/issues'
    },
    classifiers=[
